        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-2 maincontent">
                ...
                <div class="justify-content-between align-items-center pt-1 pb-2 mb-3 border-bottom mx-2">
                    <h5 class="h5 mt-3 mb-0 color-darkgray"> Faculty Lists <small>/</small></h5>
                </div>
                <!-- end title -->
                <div class="card">
                                ...
                                <div class="card-header" data-bs-toggle="collapse" data-bs-target="#collapseTable"
                                    ...
                                    <span class="card-icon"><i class="fa fa-map"></i></span> Instructors<i
                                        ...
                                        <table class="table table-bordered table-hover table-sm mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="">
                                                    <?php 
                                                        $counter = 1;
                                                        foreach($all_teachers as $teachers) {
                                                    ?>
                                                    <td><?php echo $counter++; ?></td>
                                                    <td><?php echo $teachers['fname'] .' '. $teachers['mname'] .' '. $teachers['lname'] ?>  </td>
                                                    <td><?php echo $teachers['id_number']; ?></td>
                                                    <td><?php echo $teachers['campus_desc']; ?></td>
                                                    <td><?php echo $teachers['prog_desc']; ?></td>
