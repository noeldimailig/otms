<header id="header" class="fixed-top">
    <div class="container d-flex align-items-between justify-content-between">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
            <li><a href="<?php echo site_url('student/index'); ?>">Home</a></li>
            <li><a href="<?php echo site_url('student/classes'); ?>">Classes</a></li>
            <li><a href="<?php echo site_url('student/files'); ?>">Files</a></li>
            <li><a href="<?php echo site_url('student/conference'); ?>">Conference</a></li>
