...
<head>
    ...
    <title>R&D Office Account</title>
    ...
    <div class="container-fluid">
        <div class="row p-5 my-4 rounded-3">
            <div class="col-md-5 d-flex flex-column justify-content-center align-items-center">
                <img style="width: 500px; height:auto;" src="<?= BASE_URL . PUBLIC_DIR . '/assets/img/staff.svg'; ?>" alt="">
            ...
            <div class="col-md-7">
                ...
                <h2 class="mt-4 mb-4">Research and Development Account</h2>
