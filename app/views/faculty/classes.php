        ...
        <div class="modal fade" id="add-class-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?php echo site_url('class/create'); ?>" method="post" id="create-class">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" name="u_submit" id="u_submit">Create</button>
                        </div> 
                    </form>
                </div>
            </div>
