                    ...
                    <div class="col-md-12 float-sm-start">
                        ...
                        <div class="col-md-5 p-2 float-sm-start">
                            <div class="card">
                                <div class="card-header" data-bs-toggle="collapse" data-bs-target="#collapseTable"
                                    aria-expanded="true" aria-controls="collapseTable">
                                    <span class="card-icon"><i class="fa fa-bar-chart"></i></span> Reported Researches<i class="fa fa-caret-down pull-right"></i>
                                </div>
                        ...
                        <div class="col-md-3 p-2 float-sm-start">
                            <div class="card">
                                <div class="card-header" data-bs-toggle="collapse" data-bs-target="#collapseTable"
                                    aria-expanded="true" aria-controls="collapseTable">
                                    <span class="card-icon"><i class="fa fa-bar-chart"></i></span> Researches
